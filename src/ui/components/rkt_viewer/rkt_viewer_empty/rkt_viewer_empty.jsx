...
export default class RktComponentTemplate extends Component {
    ...
    render() {
        ...
        var viewBox_style = "0 0 "+ (window.innerWidth).toString()+" "+(window.innerHeight).toString();
        console.log(viewBox_style);
        return (
            ...
            //     <div className="grid-block">
            //         <div className="grid-block">
            //             <svg className="grid-block" /*viewBox="230 -200 100 1000"*/ viewBox={viewBox_style}>
            //                 <g>
            //                     <g>
            //                         <path className="head" d="M428.719,63.242C387.936,22.46,333.713,0,276.04,0S164.142,22.46,123.36,63.242
            //                             c-40.361,40.362-62.776,93.883-63.234,150.892l-39.292,78.584c-1.756,3.512-0.513,7.784,2.856,9.804l36.429,21.858V440.36
            ...
            //                 </g>
            //             </svg>
            //             {/*<div className="medium-5 grid-block vertical rkt-viewer-empty-url-information">
            //                 <div className="grid-block"></div>
            //                 <div className="grid-block">
            //                     <h3>Rocket Viewer Links</h3>
            //                     <hr></hr>
            //                 </div>
            //                 <div className="grid-block"></div>
            ...
            // </div>*/}
            //         </div>
            //         <div className="grid-block vertical small-up-2"> 
            //             {this.renderCards()}
            //         </div>
            //         {/* <div className="rkt-viewer-empty-url-form">
            //             <div className="grid-block">
